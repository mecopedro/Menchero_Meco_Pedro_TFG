...
# Distancia física conocida entre dos puntos de referencia en cm (por ejemplo, la anchura de los hombros)
shoulder_width_cm = 40  # Este valor debería ajustarse según el sujeto o la media poblacional
...
#distancia_mediapipe_file = open('distancia_mediapipe_test7.csv', 'w')
